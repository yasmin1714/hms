...
if (isset($_GET['cancel'])) {
    $id = $_GET['id'];
    $query = mysqli_query($con, "UPDATE appointment SET userStatus='0' WHERE id = '$id'");
    if ($query) {
        $_SESSION['msg'] = "Your appointment canceled !!";
    } else {
        $_SESSION['msg'] = "Error canceling appointment: " . mysqli_error($con);
    }
}
?>
<!DOCTYPE html>
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php
                                // JOIN doctors table to get doctor's name and specialization
                                $sql = mysqli_query($con, "SELECT doctors.doctorName AS docname, doctors.specialization AS docSpecialization, appointment.*
                                                        FROM appointment
                                                        JOIN doctors ON doctors.id = appointment.doctorId
                                                        WHERE appointment.userId='" . $_SESSION['id'] . "'
                                                        ORDER BY appointment.appointmentDate DESC");  //changed order
                                $cnt = 1;
                                        ...
                                        <table class="table table-hover" id="sample-table-1" ng-show="!processing">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="username">
                                                    <?php
                                                    $query1 = mysqli_query($con, "SELECT fullName from users where id='" . $_SESSION['id'] . "'");
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['docSpecialization']; ?></td>  // Display specialization
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($row['userStatus']==1){ echo "Active"; } else { echo "Cancelled"; } ?></td>
                                            </tr>
                                            <tr>
                                                <th>Payment</th>
                                                <td><span ng-show="success" style="color:green;">Success</span> <span
                                                        ng-hide="success">Pending</span></td>
                                            </tr>
                                            <tr ng-show="success">
                                                <th>UPI ID</th>
                                                <td>{{upiId}}</td>
                            ...
                            <td style="text-align: center;">
                                <button id="printButton" onclick="captureScreenshot()" ng-show="success"
                ...
                <form name="form" ng-show="!success1">
                    ...
                    <select ng-model="paymentAmount"
                            style="background-color: #f0f0f0; font-family: 'Times New Roman'; color: #333; padding: 5px; border-radius: 20px;">
