...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_GET['del'])) {
        $insuranceId = $_GET['id'];
        mysqli_query($con, "delete from insurance where id ='$insuranceId'");
        $_SESSION['msg'] = "Insurance data deleted !!";
    }
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <title>Admin | Manage Insurance</title>
        <link
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Manage Insurance</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li>
                                    <span>Admin</span>
                    ...
                    <div class="container-fluid container-fullw bg-white">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Insurance</span></h5>
