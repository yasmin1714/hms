                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    while ($row = mysqli_fetch_array($sql)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row['assigned_doctor_id']; ?></td>
                                            <td><?php echo $row['creation_date']; ?>
                                            </td>

                                            <td>
                                                <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                    <a href="edit-nurse.php?id=<?php echo $row['id']; ?>"
                                                       class="btn btn-transparent btn-xs" tooltip-placement="top"
                                                       tooltip="Edit"><i class="fa fa-pencil"></i></a>

                                                    <a href="manage-nurses.php?id=<?php echo $row['id'] ?>&del=delete"
