...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $docspecialization = mysqli_real_escape_string($con, $docspecialization);
        $sql = mysqli_query($con, "UPDATE doctorspecilization SET specialization='$docspecialization' WHERE id='$id'");
        if ($sql) {
            $_SESSION['msg'] = "Doctor Specialization updated successfully !!";
        } else {
            $_SESSION['msg'] = "Failed to update Doctor Specialization.  Error: " . mysqli_error($con); // Include the error message.
        }
    }
