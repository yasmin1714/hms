							...
							<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Insurance </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									...
									<li>
										<a href="add-insurance.php">
											<span class="title"> Add Insurance</span>
										</a>
									</li>
									<li>
										<a href="manage-insurance.php">
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="add-billing.php">
											<span class="title"> Add Billing</span>
										</a>
									</li>
									<li>
										<a href="manage-billing.php">
											<span class="title"> Manage Billing </span>
										</a>
									</li>
